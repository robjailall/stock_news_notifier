news_sources = {
    ...
    "hhs_warp_speed": {
        "url": "https://search.hhs.gov/searchblox/servlet/SearchServlet?cname=HHS&facet=true&featuredAds=true&page=1&pagesize=10&query=Warp%2520speed%2520contract%2520",
        # "format": "json",
        # "element_selector": {
